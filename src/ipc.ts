  ...
  switch (data.type) {
    ...
    default: {
      ...
      const handlers: Array<{ mod: string; fn: string }> = [
        {
          mod: path.join(skillsRoot, 'x-integration', 'host.js'),
          fn: 'handleXIpc',
        },
        {
          mod: path.join(skillsRoot, 'linkedin-integration', 'host.js'),
          fn: 'handleLinkedInIpc',
        },
        {
          mod: path.join(skillsRoot, 'twitter-content', 'host.js'),
          fn: 'handleTwitterContentIpc',
        },
        {
          mod: path.join(skillsRoot, 'youtube-integration', 'host.js'),
          fn: 'handleYouTubeIpc',
        },
      ];
      let handled = false;
